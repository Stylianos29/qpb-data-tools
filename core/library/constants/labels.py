...
TITLE_LABELS_BY_COLUMN_NAME = {
    ...
    "APE_alpha": "$\\alpha_{\\text{APE}}$",
    "QCD_beta_value": "$\\beta$",
    "Configuration_label": "config",
    "Rho_value": "$\\rho$",
    "Bare_mass": "am",
    "Clover_coefficient": "$c_{\\text{SW}}$",
    "Delta_Min": "$\\delta\\lambda_{\\text{min}}^2$",
    "Delta_Max": "$\\delta\\lambda_{\\text{max}}^2$",
    ...
    "Preconditioner_solver_epsilon": "$\\epsilon_{\\text{prec}}$",
    "Preconditioner_MSCG_epsilon": "$\\left(\\epsilon^{\\text{prec}}_{\\text{MSCG}}\\right)^2$",
...
FILENAME_LABELS_BY_COLUMN_NAME = {
    ...
    "Preconditioner_order": "nPrec",
    "Preconditioner_mass": "mPrec",
    "Preconditioner_solver_epsilon": "EpsPrecSolver",
    "Preconditioner_MSCG_epsilon": "EpsPrecMSCG",
    "Preconditioner_max_iterations": "PrecMaxIters",
    "KL_diagonal_order": "n",
    "Zolotarev_order": "n",
    "Neuberger_order": "n",
    "Rational_order": "n",
